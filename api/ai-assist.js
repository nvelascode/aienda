...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const systemPrompt =
      ...
      '{"tipo":"gasto|actividad|cumpleanos|pago|medicamento|categoria|desconocido","campos":{}}. ' +
      'Según el tipo, "campos" debe tener EXACTAMENTE estas llaves: ' +
      'gasto: nombre (string), monto (number, sin símbolos), categoria (el nombre más parecido de la lista de categorías existentes, o el nombre de una categoría nueva razonable si ninguna calza — por ejemplo "Transporte" para un Uber — nunca dejar vacío salvo que sea imposible de inferir), fecha (YYYY-MM-DD, hoy si no se menciona otra). ' +
