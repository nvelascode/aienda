...
// AJUSTA ESTA LISTA para decidir quién puede usar la IA en Pollito.
// Por ahora: los dos correos autorizados de la familia (los mismos del login).
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const systemPrompt =
      ...
      '{"tipo":"gasto|actividad|cumpleanos|pago|medicamento|desconocido","campos":{}}. ' +
